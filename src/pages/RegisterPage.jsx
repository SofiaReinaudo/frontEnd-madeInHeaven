  ...
  return (
    ...
    >
      ...
      <Grid item sx={{ width: 450, backgroundColor: 'white', borderRadius: 2, padding: 3 }}>
        ...
        <Typography variant='h5' style={{color:'rgb(225, 176, 176)'}}>Registro</Typography>
        ...
        <Grid container>
          ...
          <Grid container direction='row' justifyContent='end' mt={2}>
            <Link to='/auth/login' style={{ textDecoration:'none', color:'rgb(225, 176, 176)'}}>Ya tienes una cuenta? Iniciar Sesión</Link>
          </Grid>
